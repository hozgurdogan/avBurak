 ...
 *
 * This file sits outside the `(public)` route group (so that it also covers
 * a bad path under `/admin`), which means it does not inherit that group's
 * header/footer from its layout - it renders its own here instead, the same
 * components the public shell uses.
 */
